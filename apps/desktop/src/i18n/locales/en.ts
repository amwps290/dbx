export default {
  ...
  connection: {
    ...
    mqttUnsubscribeMissing: "No active subscriptions found. Refresh topics and try again.",
    mqttUnsubscribeConfirm: 'Unsubscribe from "{topic}"?',
    mqttUnsubscribeGroupConfirm: "Unsubscribe from {count} topics in this group?",
    mqttUnsubscribeFailed: "Failed to unsubscribe from {count} topic(s): {errors}",
    mqttUnsubscribeTopic: "Unsubscribe from {topic}",
    mqttUnsubscribeGroup: "Unsubscribe from {count} topics in this group",
    mqttTopic: "Topic",
    ...
    mqttPayloadPlaceholderJson: 'Enter JSON, for example {"key": "value"}',
  ...
  ai: {
    ...
    maxRetriesGlobalDescription: "Number of automatic retries on transient API errors (rate limits, timeouts, network blips). Applies to all API-backed AI providers. CLI providers (claude-code, codex, pi) are unaffected.",
