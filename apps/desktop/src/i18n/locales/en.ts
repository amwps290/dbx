...
export default {
  ...
  grid: {
    ...
    resultViewUpdate: "Grid update: {ms} ms",
  ...
  tableVGroup: {
    moveToGroup: "Move to Table Group",
    moveToNewGroup: "New Group and Move In",
    removeFromGroup: "Remove from Group",
    newGroupDefault: "New Group",
    newSubgroup: "New Subgroup",
    deleteGroup: "Delete Group",
    disableGroups: "Hide Table Groups",
    enableGroups: "Show Table Groups",
    deleteGroupConfirmTitle: "Delete Table Group",
    deleteGroupConfirmMessage: 'Delete group "{name}"? Its tables return to the table list; the database is untouched.',
    groupDeleted: "Table group deleted",
  },
  connectionGroup: {
  ...
  contextMenu: {
    ...
    excludeDdlStorageHint: "Applies to OceanBase Oracle DDL display, copying and structure export. Disable to retain compression, replica and storage options. Partitions and constraints are preserved.",
