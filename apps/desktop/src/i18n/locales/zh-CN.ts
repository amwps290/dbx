...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttReceived: "接收",
    mqttRetained: "保留",
    mqttUnsubscribeMissing: "未找到可取消的订阅，Topic 列表可能已经刷新，请重试。",
    mqttUnsubscribeConfirm: "确定要取消订阅“{topic}”吗？",
    mqttUnsubscribeGroupConfirm: "确定要取消此分组下的 {count} 个订阅吗？",
    mqttUnsubscribeFailed: "有 {count} 个订阅未能取消：{errors}",
    mqttUnsubscribeTopic: "取消订阅 {topic}",
    mqttUnsubscribeGroup: "取消此分组下的 {count} 个订阅",
    mqttTopic: "Topic",
    ...
    mqttPayloadPlaceholderJson: '输入 JSON，例如 {"key": "value"}',
  ...
  ai: {
    ...
    maxRetriesGlobalDescription: "遇到临时 API 错误（限流、超时、网络波动）时的自动重试次数。适用于所有 API 模式 AI 供应商。CLI 供应商（claude-code、codex、pi）不受影响。",
