...
export default withEnglishFallback({
  ...
  grid: {
    ...
    agentExecuteTime: "执行耗时：{ms} 毫秒",
    serverExecuteTime: "数据库执行：{us} 微秒",
    ...
    clientRequestWait: "等待耗时：{ms} 毫秒",
    clientRequestWaitHint: "桌面端发出查询请求至收到完整结果的耗时，包含取行、可用时的服务端审计查询和传输，不含 SQL 准备与表格渲染；加载多页时累加各页等待时间。",
  ...
  tableVGroup: {
    ...
    disableGroups: "隐藏表分组",
    enableGroups: "显示表分组",
    deleteGroupConfirmTitle: "删除表分组",
    deleteGroupConfirmMessage: "确定删除分组「{name}」？分组内的表会回到表列表，数据库不受影响。",
    groupDeleted: "表分组已删除",
  },
  connectionGroup: {
    createGroup: "新建分组",
