...
export default withEnglishFallback({
  ...
  tableVGroup: {
    moveToGroup: "テーブルグループへ移動",
    moveToNewGroup: "新規グループを作成して移動",
    removeFromGroup: "グループから外す",
    newGroupDefault: "新規グループ",
    newSubgroup: "新規サブグループ",
    deleteGroup: "グループを削除",
    disableGroups: "テーブルグループを非表示",
    enableGroups: "テーブルグループを表示",
    deleteGroupConfirmTitle: "テーブルグループの削除",
    deleteGroupConfirmMessage: "グループ「{name}」を削除しますか？グループ内のテーブルは一覧に戻り、データベースは変更されません。",
    groupDeleted: "テーブルグループを削除しました",
  },
  connectionGroup: {
    createGroup: "新しいグループ",
    group: "グループ",
