...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttReceived: "受信",
    mqttRetained: "保持",
    mqttUnsubscribeMissing: "解除できる購読が見つかりません。トピックを更新して、もう一度お試しください。",
    mqttUnsubscribeConfirm: "「{topic}」の購読を解除しますか？",
    mqttUnsubscribeGroupConfirm: "このグループの {count} 件のトピック購読を解除しますか？",
    mqttUnsubscribeFailed: "{count} 件のトピック購読を解除できませんでした: {errors}",
    mqttUnsubscribeTopic: "{topic} の購読を解除",
    mqttUnsubscribeGroup: "このグループの {count} 件のトピック購読を解除",
    mqttTopic: "トピック",
    ...
    hiveKerberosPrincipalRequired: "Hive Kerberos プリンシパルは必須です",
