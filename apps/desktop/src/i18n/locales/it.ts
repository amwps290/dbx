...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttUnsubscribeMissing: "Nessuna sottoscrizione attiva trovata. Aggiorna i Topic e riprova.",
    mqttUnsubscribeConfirm: 'Annullare la sottoscrizione a "{topic}"?',
    mqttUnsubscribeGroupConfirm: "Annullare la sottoscrizione a {count} Topic in questo gruppo?",
    mqttUnsubscribeFailed: "Impossibile annullare la sottoscrizione a {count} Topic: {errors}",
    mqttUnsubscribeTopic: "Annulla la sottoscrizione a {topic}",
    mqttUnsubscribeGroup: "Annulla la sottoscrizione a {count} Topic in questo gruppo",
    mqttTopic: "Topic",
    ...
    mqttPayloadPlaceholderJson: 'Inserisci JSON, ad esempio {"key": "value"}',
  ...
  ai: {
    ...
    maxRetriesGlobalDescription: "Numero di tentativi automatici su errori API transitori (limite di velocità, timeout, problemi di rete). Si applica a tutti i provider IA via API. I provider CLI (claude-code, codex, pi) non sono interessati.",
  ...
  transfer: {
    ...
    dataWriteMode: "Modalità di scrittura dati",
    source: "Sorgente",
    target: "Destinazione",
