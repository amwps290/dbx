...
export default withEnglishFallback({
  ...
  tableVGroup: {
    moveToGroup: "Sposta nel gruppo tabelle",
    ...
    deleteGroup: "Elimina gruppo",
    disableGroups: "Nascondi gruppi tabelle",
    enableGroups: "Mostra gruppi tabelle",
    deleteGroupConfirmTitle: "Elimina gruppo tabelle",
    deleteGroupConfirmMessage: "Eliminare il gruppo «{name}»? Le tabelle tornano nell'elenco e il database non viene modificato.",
    groupDeleted: "Gruppo tabelle eliminato",
  },
  connectionGroup: {
  ...
  contextMenu: {
    ...
    excludeDdlStorageHint: "Si applica alla visualizzazione e alla copia del DDL e all'esportazione della struttura in OceanBase Oracle. Disattiva questa opzione per mantenere i parametri di compressione, replica e archiviazione. Le partizioni e i vincoli vengono sempre mantenuti.",
