...
export default withEnglishFallback({
  ...
  grid: {
    ...
    agentExecuteTime: "執行耗時：{ms} 毫秒",
    serverExecuteTime: "資料庫執行：{us} 微秒",
    ...
    clientRequestWait: "等待耗時：{ms} 毫秒",
    clientRequestWaitHint: "桌面端送出查詢請求至收到完整結果的耗時，包含讀取資料列、可用時的伺服端稽核查詢與傳輸，不含 SQL 準備與表格呈現；載入多頁時累加各頁等待時間。",
    resultViewUpdate: "表格更新：{ms} 毫秒",
  ...
  tableVGroup: {
    ...
    disableGroups: "隱藏表分組",
    enableGroups: "顯示表分組",
    deleteGroupConfirmTitle: "刪除表分組",
    deleteGroupConfirmMessage: "確定刪除分組「{name}」？分組內的資料表會回到清單，資料庫不受影響。",
    groupDeleted: "表分組已刪除",
  },
  connectionGroup: {
    createGroup: "建立群組",
  ...
  contextMenu: {
    ...
    excludeDdlStorageHint: "用於 OceanBase Oracle 的 DDL 顯示、複製和結構匯出。關閉後保留壓縮、副本和儲存參數；分割區和約束條件一律保留。",
