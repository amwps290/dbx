...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttRetained: "Retido",
    mqttUnsubscribeMissing: "Nenhuma inscrição ativa encontrada. Atualize os Topics e tente novamente.",
    mqttUnsubscribeConfirm: 'Cancelar a inscrição em "{topic}"?',
    mqttUnsubscribeGroupConfirm: "Cancelar a inscrição em {count} Topics deste grupo?",
    mqttUnsubscribeFailed: "Falha ao cancelar a inscrição em {count} Topic(s): {errors}",
    mqttUnsubscribeTopic: "Cancelar a inscrição em {topic}",
    mqttUnsubscribeGroup: "Cancelar a inscrição em {count} Topics deste grupo",
    mqttTopic: "Topic",
    ...
    mqttPayloadPlaceholderJson: 'Digite JSON, por exemplo {"key": "value"}',
  ...
  ai: {
    ...
    maxRetriesGlobalDescription: "Número de tentativas automáticas em erros transitórios de API (limite de taxa, timeout, falhas de rede). Aplica-se a todos os provedores de IA via API. Provedores CLI (claude-code, codex, pi) não são afetados.",
  ...
  transfer: {
    ...
    content: "Conteúdo de transferência",
    ...
    dataWriteMode: "Modo de gravação de dados",
    source: "Origem",
    target: "Destino",
