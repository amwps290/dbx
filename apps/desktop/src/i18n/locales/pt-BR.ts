...
export default withEnglishFallback({
  ...
  grid: {
    agentExecuteTime: "Execução: {ms} ms",
    serverExecuteTime: "Execução no BD: {us} µs",
    ...
    resultViewUpdate: "Atualização da tabela: {ms} ms",
  ...
  tableVGroup: {
    moveToGroup: "Mover para grupo de tabelas",
    moveToNewGroup: "Novo grupo e mover",
    removeFromGroup: "Remover do grupo",
    newGroupDefault: "Novo grupo",
    newSubgroup: "Novo subgrupo",
    deleteGroup: "Excluir grupo",
    disableGroups: "Ocultar grupos de tabelas",
    enableGroups: "Mostrar grupos de tabelas",
    deleteGroupConfirmTitle: "Excluir grupo de tabelas",
    deleteGroupConfirmMessage: 'Excluir o grupo "{name}"? As tabelas voltam para a lista e o banco de dados não é alterado.',
    groupDeleted: "Grupo de tabelas excluído",
  },
  connectionGroup: {
  ...
  contextMenu: {
    ...
    excludeDdlStorageHint: "Aplica-se à exibição e cópia de DDL e à exportação de estruturas do OceanBase Oracle. Desative esta opção para manter os parâmetros de compressão, réplicas e armazenamento. As partições e restrições são sempre mantidas.",
