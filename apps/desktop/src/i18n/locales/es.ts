...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttUnsubscribeMissing: "No se encontraron suscripciones activas. Actualiza los Topics e inténtalo de nuevo.",
    mqttUnsubscribeConfirm: '¿Cancelar la suscripción a "{topic}"?',
    mqttUnsubscribeGroupConfirm: "¿Cancelar la suscripción a {count} Topics de este grupo?",
    mqttUnsubscribeFailed: "No se pudo cancelar la suscripción a {count} Topic(s): {errors}",
    mqttUnsubscribeTopic: "Cancelar la suscripción a {topic}",
    mqttUnsubscribeGroup: "Cancelar la suscripción a {count} Topics de este grupo",
    mqttTopic: "Topic",
  ...
  transfer: {
    ...
    dataWriteMode: "Modo de escritura de datos",
    source: "Origen",
    target: "Destino",
  ...
  mqMessages: {
    ...
    kafkaLatestHint: "Lee una ventana equilibrada cerca del final de cada partición y combina por marca de tiempo con los más nuevos primero.",
    kafkaEarliestHint: "Lee el historial hacia adelante desde cada partición seleccionada.",
    kafkaOffsetHint: "Lee hacia adelante desde el offset indicado en la partición elegida, o en todas si se deja vacía.",
