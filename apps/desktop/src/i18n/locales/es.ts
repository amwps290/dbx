...
export default withEnglishFallback({
  ...
  tableVGroup: {
    moveToGroup: "Mover a grupo de tablas",
    moveToNewGroup: "Nuevo grupo y mover",
    removeFromGroup: "Quitar del grupo",
    newGroupDefault: "Nuevo grupo",
    newSubgroup: "Nuevo subgrupo",
    deleteGroup: "Eliminar grupo",
    disableGroups: "Ocultar grupos de tablas",
    enableGroups: "Mostrar grupos de tablas",
    deleteGroupConfirmTitle: "Eliminar grupo de tablas",
    deleteGroupConfirmMessage: "¿Eliminar el grupo «{name}»? Sus tablas vuelven a la lista y la base de datos no se modifica.",
    groupDeleted: "Grupo de tablas eliminado",
  },
  connectionGroup: {
  ...
  contextMenu: {
    ...
    excludeDdlStorageHint: "Se aplica a la visualización y copia de DDL y a la exportación de estructuras de OceanBase Oracle. Desactiva esta opción para conservar los parámetros de compresión, réplicas y almacenamiento. Las particiones y restricciones se conservan siempre.",
